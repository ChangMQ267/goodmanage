...
public class UpdateGoodsServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		double goodprice = Double.parseDouble(request.getParameter("productPrice"));
		int goodcount = Integer.parseInt(request.getParameter("productCount"));
		String goodDep = request.getParameter("productDep");
		int goodtype = Integer.parseInt(request.getParameter("productType"));
