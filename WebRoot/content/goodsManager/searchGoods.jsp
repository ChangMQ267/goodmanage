								...
								*/
								...
								<c:forEach items="${goods }" var="goodss">
								 <TR>
								  ...
								  <TD class=gridViewItem><A class=cmdField   href="<%=path%>/servlet/EditDelGoodsServlet?goodsid=${goodss.id}">编辑</A></TD>
								  <TD class=gridViewItem><a class=cmdField  href="<%=path%>/servlet/EditDelGoodsServlet?goodsid=${goodss.id}&op=del">删除 </a></TD>
								</TR>
                                   </c:forEach>
							</table>
						</div>
