...
int goodstype = ((Goods)session.getAttribute("goods2")).getGoodtype();
    ...
    <TBODY>
      ...
      <TR>
        ...
        <TD class="main_nu" vAlign=top align=middle>
           <DIV>
          <form action="<%=path %>/servlet/UpdateGoodsServlet"  method='post' onsubmit="return check()">
          <input type='hidden' name='productID' value="${goods2.id }">
            <TABLE class=gridView style="WIDTH: 80%; BORDER-COLLAPSE: collapse"  cellSpacing=0 rules=all  border=1>
              <TBODY>
                ...
                <TR>
                  ...
                  <TD class=gridViewItem><input class=gridViewItem value="${goods2.id }" type="text" id='productId' name="productId"></TD>
                   
                  <TD class=gridViewItem>商品名称 </TD>
                  <TD class=gridViewItem><input class=gridViewItem value="${goods2.goodname }" type="text" id='productName' name="productName"></TD>
                    </TR>
               <TR>
                  <TD class=gridViewItem>商品价格</TD>
                  <TD class=gridViewItem><input  class=gridViewItem type="text" id='productPrice' value="${goods2.goodprice }" name="productPrice"></TD>
             
                  <TD class=gridViewItem> 商品数量</TD>
                  <TD class=gridViewItem><input class=gridViewItem id='productCount' value='${goods2.goodcount }' name="productCount"></TD>
                    </TR>
                 <TR>
                  ...
                  <TD class=gridViewItem>
						<select name="productType" style="WIDTH:45% ;color:#566984" >			
						   ...
						   <%if(goodstype == ((GoodsType)pageContext.findAttribute("gtype")).getId()){out.print("selected");} %>>${gtype.typeName }</option>  	
						   </c:forEach>
						</select>  
				  </TD>
                  <TD class=gridViewItem>商品描述</TD>
                  <TD class=gridViewItem><input   class=gridViewItem type="text" value='${goods2.goodDep }' id='productDep' name="productDep"></TD>
